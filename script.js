        ...
        axios.get(queryURL).then(function(results) {
            ...
            <body>
                ...
                <div class="jumbotron">
                    ...
                    <div class="d-flex justify-content-center">
                      <a class="btn btn-secondary btn-md" href="https://www.google.com/maps/@?api=1&map_action=map&query=${location}" role="button" target="_blank">${location}</a>
